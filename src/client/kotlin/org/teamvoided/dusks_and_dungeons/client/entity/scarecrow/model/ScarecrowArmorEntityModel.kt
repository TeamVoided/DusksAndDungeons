package org.teamvoided.dusks_and_dungeons.client.entity.scarecrow.model
    ...
    companion object {
        fun getModelData(dilation: CubeDeformation): MeshDefinition {
            ...
            val post = modelPartData.addOrReplaceChild(
                ...
                PartPose.offset(0f, ScarecrowEntityModel.POST_OFFSET, 0f)
            )
            val body = post.addOrReplaceChild(
                ...
                PartPose.offset(0f, ScarecrowEntityModel.BODY_OFFSET, 0f)
            )
