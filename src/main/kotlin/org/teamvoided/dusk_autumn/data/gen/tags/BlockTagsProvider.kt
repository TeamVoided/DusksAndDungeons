...
class BlockTagsProvider(output: FabricDataOutput, registriesFuture: CompletableFuture<HolderLookup.Provider>) :
    ...
    fun vanillaTags() {
        ...
        getOrCreateTagBuilder(BlockTags.MUSHROOM_GROW_BLOCK)
            .add(DuskBlocks.ROCKY_PODZOL)
            .add(DuskBlocks.SLATED_PODZOL)
            .add(DuskBlocks.BLACKSTONE_PODZOL)
            .add(DuskBlocks.ROCKY_MYCELIUM)
            .add(DuskBlocks.SLATED_MYCELIUM)
            .add(DuskBlocks.BLACKSTONE_MYCELIUM)
            .forceAddTag(BlockTags.LOGS)

        getOrCreateTagBuilder(BlockTags.OVERWORLD_CARVER_REPLACEABLES)
            .add(DuskBlocks.ROCKY_GRAVEL)
            .add(DuskBlocks.SLATED_GRAVEL)
            .add(DuskBlocks.BLACKSTONE_GRAVEL)
        getOrCreateTagBuilder(BlockTags.NETHER_CARVER_REPLACEABLES)
            .add(DuskBlocks.ROCKY_SOUL_SAND)
            .add(DuskBlocks.SLATED_SOUL_SAND)
            .add(DuskBlocks.BLACKSTONE_SOUL_SAND)
            .add(DuskBlocks.ROCKY_SOUL_SOIL)
            .add(DuskBlocks.SLATED_SOUL_SOIL)
            .add(DuskBlocks.BLACKSTONE_SOUL_SOIL)
        getOrCreateTagBuilder(BlockTags.SCULK_REPLACEABLE)
            .add(DuskBlocks.ROCKY_GRAVEL)
            .add(DuskBlocks.SLATED_GRAVEL)
            .add(DuskBlocks.BLACKSTONE_GRAVEL)
            .add(DuskBlocks.ROCKY_SAND)
            .add(DuskBlocks.SLATED_SAND)
            .add(DuskBlocks.BLACKSTONE_SAND)
            .add(DuskBlocks.ROCKY_RED_SAND)
            .add(DuskBlocks.SLATED_RED_SAND)
            .add(DuskBlocks.BLACKSTONE_RED_SAND)
            .add(DuskBlocks.ROCKY_SOUL_SAND)
            .add(DuskBlocks.SLATED_SOUL_SAND)
            .add(DuskBlocks.BLACKSTONE_SOUL_SAND)
            .add(DuskBlocks.ROCKY_SOUL_SOIL)
        ...
        getOrCreateTagBuilder(BlockTags.DIRT)
            .add(DuskBlocks.ROCKY_DIRT)
            .add(DuskBlocks.SLATED_DIRT)
            .add(DuskBlocks.BLACKSTONE_DIRT)
            .add(DuskBlocks.ROCKY_GRASS)
            .add(DuskBlocks.SLATED_GRASS)
            .add(DuskBlocks.BLACKSTONE_GRASS)
            .add(DuskBlocks.ROCKY_PODZOL)
            .add(DuskBlocks.SLATED_PODZOL)
            .add(DuskBlocks.BLACKSTONE_PODZOL)
            .add(DuskBlocks.ROCKY_MYCELIUM)
            .add(DuskBlocks.SLATED_MYCELIUM)
            .add(DuskBlocks.BLACKSTONE_MYCELIUM)
            .add(DuskBlocks.ROCKY_COARSE_DIRT)
            .add(DuskBlocks.SLATED_COARSE_DIRT)
            .add(DuskBlocks.BLACKSTONE_COARSE_DIRT)
            .add(DuskBlocks.ROCKY_MUD)
            .add(DuskBlocks.SLATED_MUD)
            .add(DuskBlocks.BLACKSTONE_MUD)
        ...
        getOrCreateTagBuilder(BlockTags.SNOW)
            .add(DuskBlocks.ROCKY_SNOW)
            .add(DuskBlocks.SLATED_SNOW)
            .add(DuskBlocks.BLACKSTONE_SNOW)
        ...
        getOrCreateTagBuilder(BlockTags.PICKAXE_MINEABLE)
            ...
            .add(DuskBlocks.SLATED_MYCELIUM)
            .add(DuskBlocks.BLACKSTONE_MYCELIUM)
            .add(DuskBlocks.ROCKY_DIRT_PATH)
            .add(DuskBlocks.SLATED_DIRT_PATH)
            .add(DuskBlocks.BLACKSTONE_DIRT_PATH)
            .add(DuskBlocks.ROCKY_COARSE_DIRT)
            .add(DuskBlocks.SLATED_COARSE_DIRT)
            .add(DuskBlocks.BLACKSTONE_COARSE_DIRT)
            .add(DuskBlocks.ROCKY_MUD)
