...
//
//open class TEMP(codec: Codec<VegetationPatchFeatureConfig>) :
...
//        val vegetationPatchFeatureConfig = context.config
...
//        val set: MutableSet<BlockPos> = HashSet<Any>()
//
...
//                            mutable,
//                            Predicate<BlockState> { AbstractBlock.AbstractBlockState.isAir() }) && k < config.verticalRange
//                    ) {
...
//        pos: BlockPos
//    ): Boolean {
//        return config.vegetationFeature.value().place(
//            world,
//            generator,
//            random,
