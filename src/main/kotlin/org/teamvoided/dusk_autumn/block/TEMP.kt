...
//        return if (state.get(LAYERS) as Int == 8) 0.2f else 1.0f
//    }
//
...
//                this
//            ) && blockState.get(LAYERS) as Int == 8
//        }
//    }
//
...
//        return if (context.stack.isOf(this.asItem()) && i < 8) {
