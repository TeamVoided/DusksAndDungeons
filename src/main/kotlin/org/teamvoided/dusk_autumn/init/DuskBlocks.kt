...
object DuskBlocks {
    ...
    val SOUL_CANDLE = register("soul_candle", bigCandleOf(MapColor.SAND))
    val WHITE_SOUL_CANDLE = register("white_soul_candle", bigCandleOf(MapColor.WOOL))
    val LIGHT_GRAY_SOUL_CANDLE = register("light_gray_soul_candle", bigCandleOf(MapColor.LIGHT_GRAY))
    val GRAY_SOUL_CANDLE = register("gray_soul_candle", bigCandleOf(MapColor.GRAY))
    val BLACK_SOUL_CANDLE = register("black_soul_candle", bigCandleOf(MapColor.BLACK))
    val BROWN_SOUL_CANDLE = register("brown_soul_candle", bigCandleOf(MapColor.BROWN))
    val RED_SOUL_CANDLE = register("red_soul_candle", bigCandleOf(MapColor.RED))
    val ORANGE_SOUL_CANDLE = register("orange_soul_candle", bigCandleOf(MapColor.ORANGE))
    val YELLOW_SOUL_CANDLE = register("yellow_soul_candle", bigCandleOf(MapColor.YELLOW))
    val LIME_SOUL_CANDLE = register("lime_soul_candle", bigCandleOf(MapColor.LIME))
    val GREEN_SOUL_CANDLE = register("green_soul_candle", bigCandleOf(MapColor.GREEN))
    val CYAN_SOUL_CANDLE = register("cyan_soul_candle", bigCandleOf(MapColor.CYAN))
    val LIGHT_BLUE_SOUL_CANDLE = register("light_blue_soul_candle", bigCandleOf(MapColor.LIGHT_BLUE))
    val BLUE_SOUL_CANDLE = register("blue_soul_candle", bigCandleOf(MapColor.BLUE))
    val PURPLE_SOUL_CANDLE = register("purple_soul_candle", bigCandleOf(MapColor.PURPLE))
    val MAGENTA_SOUL_CANDLE = register("magenta_soul_candle", bigCandleOf(MapColor.MAGENTA))
    val PINK_SOUL_CANDLE = register("pink_soul_candle", bigCandleOf(MapColor.PINK))
