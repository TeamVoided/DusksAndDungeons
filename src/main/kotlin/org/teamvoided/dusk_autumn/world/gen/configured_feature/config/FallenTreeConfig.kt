        ...
        val CODEC =
            RecordCodecBuilder.create { instance: RecordCodecBuilder.Instance<FallenTreeConfig> ->
                instance.group(
                    ...
                    TagKey.createHashedCodec(RegistryKeys.BLOCK).fieldOf("allowed_placenemt").forGetter { it.allowedPlacement },
                    ...
                    IntProvider.create(0, 32).fieldOf("stump_height").forGetter { it.stumpHeight },
                    IntProvider.create(0, 32).fieldOf("trunk_length").forGetter { it.trunkLength },
                    IntProvider.create(0, 16).fieldOf("trunk_distance_from_stump").forGetter { it.trunkDistanceFromStump },
