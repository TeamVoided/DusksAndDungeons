...
class BlockTagsProvider(output: FabricDataOutput, registriesFuture: CompletableFuture<HolderLookup.Provider>) :
    ...
    private fun duskTags() {
        ...
        getOrCreateTagBuilder(DnDBlockTags.NETHER_BRICKS)
            ...
            .add(DnDNetherBrickBlocks.MIXED_RED_NETHER_BRICKS.parent)
            .add(Blocks.RED_NETHER_BRICKS)
            .add(DnDNetherBrickBlocks.BLUE_NETHER_BRICKS.parent)
            .add(DnDNetherBrickBlocks.MIXED_BLUE_NETHER_BRICKS.parent)
            .add(DnDNetherBrickBlocks.GRAY_NETHER_BRICKS.parent)
            .add(DnDNetherBrickBlocks.MIXED_GRAY_NETHER_BRICKS.parent)
        getOrCreateTagBuilder(DnDBlockTags.CRACKED_NETHER_BRICKS)
            .add(Blocks.CRACKED_NETHER_BRICKS)
            .add(DnDNetherBrickBlocks.CRACKED_MIXED_RED_NETHER_BRICKS)
        ...
        getOrCreateTagBuilder(DnDBlockTags.POLISHED_NETHER_BRICKS)
            .add(DnDNetherBrickBlocks.POLISHED_NETHER_BRICKS.parent)
            .add(DnDNetherBrickBlocks.POLISHED_RED_NETHER_BRICKS.parent)
            .add(DnDNetherBrickBlocks.POLISHED_BLUE_NETHER_BRICKS.parent)
            .add(DnDNetherBrickBlocks.POLISHED_GRAY_NETHER_BRICKS.parent)
    ...
    private fun vanillaBlockTypeShapeTags() {
        getOrCreateTagBuilder(BlockTags.FENCES)
            ...
            .add(DnDNetherBrickBlocks.MIXED_RED_NETHER_BRICK_FENCE)
