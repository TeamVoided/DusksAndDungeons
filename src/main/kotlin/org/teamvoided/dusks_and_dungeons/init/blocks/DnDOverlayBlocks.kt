...
object DnDOverlayBlocks {
    val ROCKY_DIRT =
        DnDBlocks.register(
            "dirty_rocks", Block(copy(DIRT).mapColor(COBBLESTONE.defaultMapColor)).cutout().pickaxe().shovel()
        )
    val ROCKY_GRASS = DnDBlocks.register(
        "grassy_rocks", RockyGrassBlock(ROCKY_DIRT, copy(GRASS_BLOCK).mapColor(COBBLESTONE.defaultMapColor))
            .cutout().grass().pickaxe().shovel()
    )
    val ROCKY_PODZOL =
        DnDBlocks.register(
            "podzol_rocks", SnowyBlock(copy(PODZOL).mapColor(COBBLESTONE.defaultMapColor)).cutout().pickaxe().shovel()
        )
    val ROCKY_MYCELIUM = DnDBlocks.register(
        "mycelium_rocks", RockyMyceliumBlock(ROCKY_DIRT, copy(MYCELIUM).mapColor(COBBLESTONE.defaultMapColor))
    ...
    val ROCKY_DIRT_PATH = DnDBlocks.register(
        "rocky_path", RockyDirtPathBlock(ROCKY_DIRT, copy(DIRT_PATH).mapColor(COBBLESTONE.defaultMapColor)).cutout()
    )
    val ROCKY_MUD =
    ...
    val ROCKY_GRAVEL = DnDBlocks.register(
        "rocky_rocks", GravelBlock(Color(-8356741), copy(GRAVEL).mapColor(COBBLESTONE.defaultMapColor))
            .cutout().pickaxe().shovel()
    )
    ...
    val ROCKY_SOUL_SOIL = DnDBlocks.register(
        "rocky_soul_soil", Block(copy(SOUL_SOIL).mapColor(COBBLESTONE.defaultMapColor)).cutout().pickaxe().shovel()
    )

    val SLATED_DIRT = DnDBlocks.register(
        "dirty_slate", Block(copy(DIRT).mapColor(COBBLED_DEEPSLATE.defaultMapColor)).cutout().pickaxe().shovel()
    )
    val SLATED_GRASS = DnDBlocks.register(
        "grassy_slate", RockyGrassBlock(SLATED_DIRT, copy(GRASS_BLOCK).mapColor(COBBLED_DEEPSLATE.defaultMapColor))
            .cutout().grass().pickaxe().shovel()
    )
    val SLATED_PODZOL = DnDBlocks.register(
        "podzol_slate", SnowyBlock(copy(PODZOL).mapColor(COBBLED_DEEPSLATE.defaultMapColor)).cutout().pickaxe().shovel()
    )
    val SLATED_MYCELIUM = DnDBlocks.register(
        "mycelium_slate", RockyMyceliumBlock(SLATED_DIRT, copy(MYCELIUM).mapColor(COBBLED_DEEPSLATE.defaultMapColor))
            .cutout().pickaxe().shovel()
    )
    val SLATED_COARSE_DIRT = DnDBlocks.register(
    ...
    val SLATED_DIRT_PATH = DnDBlocks.register(
        "slated_path", RockyDirtPathBlock(SLATED_DIRT, copy(DIRT_PATH).mapColor(COBBLED_DEEPSLATE.defaultMapColor))
            .cutout().pickaxe().shovel()
    )
    val SLATED_MUD = DnDBlocks.register(
        "muddy_slate", MudBlock(copy(MUD).mapColor(COBBLED_DEEPSLATE.defaultMapColor)).cutout().pickaxe().shovel()
    )
    val SLATED_SNOW = DnDBlocks.register(
        "snowy_slate", Block(copy(SNOW_BLOCK).mapColor(COBBLED_DEEPSLATE.defaultMapColor)).cutout().pickaxe().shovel()
    )
    val SLATED_GRAVEL = DnDBlocks.register(
        "slated_slate", GravelBlock(Color(-8356741), copy(GRAVEL).mapColor(COBBLED_DEEPSLATE.defaultMapColor))
            .cutout().pickaxe().shovel()
    )
    val SLATED_SAND = DnDBlocks.register(
        "sandy_slate", GravelBlock(Color(14406560), copy(SAND).mapColor(COBBLED_DEEPSLATE.defaultMapColor))
            .cutout().pickaxe().shovel()
    )
    val SLATED_RED_SAND = DnDBlocks.register(
        "red_sandy_slate", GravelBlock(Color(11098145), copy(RED_SAND).mapColor(COBBLED_DEEPSLATE.defaultMapColor))
            .cutout().pickaxe().shovel()
    )
    val SLATED_SOUL_SAND = DnDBlocks.register(
        "slated_soul_sand",
        SoulSandBlock(copy(SOUL_SAND).mapColor(COBBLED_DEEPSLATE.defaultMapColor)).cutout().pickaxe().shovel()
    )
    val SLATED_SOUL_SOIL = DnDBlocks.register(
        "slated_soul_soil",
        Block(copy(SOUL_SOIL).mapColor(COBBLED_DEEPSLATE.defaultMapColor)).cutout().pickaxe().shovel()
    )

    val BLACKSTONE_DIRT = DnDBlocks.register(
        "dirty_blackstone", Block(copy(DIRT).mapColor(COBBLED_DEEPSLATE.defaultMapColor)).cutout().pickaxe().shovel()
    )
    ...
    val BLACKSTONE_PODZOL = DnDBlocks.register(
        "podzol_blackstone",
    ...
    val BLACKSTONE_COARSE_DIRT = DnDBlocks.register(
    ...
    val BLACKSTONE_MUD = DnDBlocks.register(
        "muddy_blackstone", MudBlock(copy(MUD).mapColor(COBBLED_DEEPSLATE.defaultMapColor)).cutout().pickaxe().shovel()
    )
    val BLACKSTONE_SNOW = DnDBlocks.register(
        "snowy_blackstone",
    ...
    val BLACKSTONE_GRAVEL = DnDBlocks.register(
        "blackstoned_blackstone", GravelBlock(Color(-8356741), copy(GRAVEL).mapColor(COBBLED_DEEPSLATE.defaultMapColor))
            .cutout().pickaxe().shovel()
    )
    val BLACKSTONE_SAND = DnDBlocks.register(
        "sandy_blackstone", GravelBlock(Color(14406560), copy(SAND).mapColor(COBBLED_DEEPSLATE.defaultMapColor))
            .cutout().pickaxe().shovel()
    )
    val BLACKSTONE_RED_SAND = DnDBlocks.register(
        "red_sandy_blackstone", GravelBlock(Color(11098145), copy(RED_SAND).mapColor(COBBLED_DEEPSLATE.defaultMapColor))
            .cutout().pickaxe().shovel()
    )
    ...
    val BLACKSTONE_SOUL_SOIL = DnDBlocks.register(
